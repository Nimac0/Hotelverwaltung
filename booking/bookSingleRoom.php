...
<section class= "header">
    ...
    <div class = "container">
          <h2 class="subtitle">Single room with city view</h2><h3>150$/day</h3>
          <div class="images">
            <div>
              <img src="../res/img/hotel-room2.jpg" alt="">
              <img src="../res/img/bathroom.jpg" alt="">
            </div>
            <div>
              <img src="../res/img/window.jpg" alt="">
            </div>
          </div>
...
<div class= "box">
    ...
    <?php
    $roomType = "single"; //the same code is used for all three room options only the roomType is set differently for each page
